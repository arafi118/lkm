                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="alert alert-info d-flex align-items-center" role="alert" style="background-color: #e7f3fe; color: #31708f; border: 1px solid #bce8f1;">
                                        ...
                                        <span>
                                            Biarkan kolom ini kosong untuk memproses semua CIF. Jika hanya ingin memproses beberapa CIF tertentu, silakan masukkan dalam format: <strong>CIF1, CIF2, CIF3</strong>, dan seterusnya.
                                        </span>
                                    </div>
                                </div>
                            </div>
