            ...
            <div class="col-md-4">
                <div class="position-relative mb-3">
                    ...
                    <input autocomplete="off" type="text" name="nama_pangilan" id="nama_pangilan"
                        class="form-control" value="{{ $data_anggota->nama_pangilan }}">
            ...
            <div class="col-md-4">
                <div class="position-relative mb-3">
                    ...
                    <input autocomplete="off" maxlength="16" type="text" name="alamat" id="alamat"
                        class="form-control" value="{{ $data_anggota->alamat }}">
            ...
            <div class="col-md-4">
                <div class="position-relative mb-3">
                    ...
                    <input autocomplete="off" type="text" name="tempat_kerja" id="tempat_kerja"
                        class="form-control" value="{{ $data_anggota->tempat_kerja }}">
            ...
            <div class="col-md-4">
                <div class="position-relative mb-3">
                    ...
                    <input autocomplete="off" type="text" name="jenis_usaha" id="jenis_usaha"
                        class="form-control" value="{{ $data_anggota->jenis_usaha }}">
            ...
            <div class="col-md-4">
                <div class="position-relative mb-3">
                    ...
                    <input autocomplete="off" type="text" name="nik_penjamin" id="nik_penjamin"
                        class="form-control" value="{{ $data_anggota->nik_penjamin }}" maxlength="16"
                        minlength="16">
