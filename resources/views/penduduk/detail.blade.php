        ...
        <div class="card-body">
            <div class="nav-wrapper position-relative end-0">
                ...
                <div class="tab-content mt-2">
                    <div class="tab-pane fade show active" id="ProfilPenduduk" role="tabpanel"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="position-relative mb-3">
                                                ...
                                                <input autocomplete="off" type="text" name="nama_pangilan"
                                                    id="nama_pangilan" class="form-control"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="position-relative mb-3">
                                                ...
                                                <select class="detailselect2 form-control" name="jenis_kelamin"
                                                    id="jenis_kelamin">
                                        ...
                                        <div class="col-md-4">
                                            <div class="position-relative mb-3">
                                                ...
                                                <input autocomplete="off" type="text" name="alamat"
                                                    value="{{ $penduduk->alamat }}"id="alamat" class="form-control"
                                                    value="">
                                        ...
                                        <div class="col-md-4">
                                            <div class="position-relative mb-3">
                                                ...
                                                <input autocomplete="off" type="text"
                                                    name="domisi"value="{{ $penduduk->domisi }}" id="domisi"
                                                    class="form-control">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="position-relative mb-3">
                                                ...
                                                <select class="detailselect2 form-control" name="agama" id="agama"
                                                    class="form-control">
                                                    <option value="{{ $penduduk->agama }}">{{ $penduduk->agama }}
                                                    </option>
                                        ...
                                        <div class="col-md-2">
                                            <div class="position-relative mb-3">
                                                ...
                                                <select class="detailselect2 form-control" name="pendidikan"
                                                    id="pendidikan" class="form-control">
                                                    <option value="{{ $penduduk->pendidikan }}">
                                                        {{ $penduduk->pendidikan }}</option>
                                        ...
                                        <div class="col-md-2">
                                            <div class="position-relative mb-3">
                                                ...
                                                <select class="detailselect2 form-control" name="status_pernikahan"
                                                    id="status_pernikahan" class="form-control">
                                                    <option value="{{ $penduduk->status_pernikahan }}">
                                                        {{ $penduduk->status_pernikahan }}</option>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="position-relative mb-3">
                                                ...
                                                <input autocomplete="off" type="text" name="nama_ibu" id="nama_ibu"
                                                    class="form-control" value="{{ $penduduk->nama_ibu }}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="position-relative mb-3">
                                                ...
                                                <input autocomplete="off" type="text" name="tempat_kerja"
                                                    id="tempat_kerja" class="form-control"
                                        ...
                                        <div class="col-md-4">
                                            <div class="position-relative mb-3">
                                                ...
                                                <input autocomplete="off" type="text" name="jenis_usaha"
                                                    id="jenis_usaha" class="form-control"
                                                    value="{{ $penduduk->usaha }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="position-relative mb-3">
                                                ...
                                                <select class="detailselect2 form-control" name="hubungan"
                                                    id="hubungan">
