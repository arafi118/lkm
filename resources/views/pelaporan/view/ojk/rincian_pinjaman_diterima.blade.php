...
@section('content')
    ...
    @foreach ($jenis_pp as $jpp)
        ...
        <table width="96%" border="0" align="center" cellpadding="3" cellspacing="0">
            ...
            <tr>
                <td height="20" colspan="8" class="style6 bottom align-center"><br>DAFTAR RINCIAN PINJAMAN YANG
                    DITERIMA
                    <br><br>
                </td>
            </tr>
        ...
        <table width="96%" border="0" align="center" cellpadding="3" cellspacing="0">
            ...
            <tr>
                <td class="style10 top" colspan="7"><b>Keterangan</b>: Data yang ditampilkan di atas merupakan Tabungan
                    pada tahun berjalan {{ $tahun }}, untuk menampilkan data Individu aktif tahun lalu dapat memilih
                    mode tahun lalu {{ $y12 }}.
                </td>
            </tr>
        </table>
