...
@foreach ($jenis_pp as $jpp)
    ...
    <table width="96%" border="0" align="center" cellpadding="3" cellspacing="0">
        <tr align="center" height="30px" class="style9">
            <th width="3%" rowspan="2" class="left bottom">No</th>
            <th width="18%" rowspan="2" class="left bottom">Peminjam - Loan ID</th>
            <th width="12%" rowspan="2" class="left bottom">Jenis Penggunaan</th>
            ...
            <th width="7%" rowspan="2" class="left bottom">Plafon</th>
            <th width="8%" rowspan="2" class="left bottom">Baki Debet</th>
            <th width="6%" rowspan="2" class="left bottom">Tunggakan</th>
            <th width="5%" rowspan="2" class="left right bottom">Kualitas</th>
            <th width="6%" rowspan="2" class="left right bottom">Jenis Agunan</th>
            <th width="9%" rowspan="2" class="left right bottom">Nilai Agunan</th>
        </tr>
        <tr align="center" height="30px" class="style9">
            <th width="6%" class="left bottom">Mulai</th>
            <th width="6%" class="left bottom">Jatuh Tempo</th>
            <th width="4%" class="left bottom">%</th>
        ...
        @foreach ($jpp->pinjaman_individu as $pinj_i)
            ...
            @if (array_count_values($kd_desa)[$pinj_i->kd_desa] <= '1' ) 
                @if ($section != $desa && count($kd_desa)> 1)
                    <tr style="font-weight: bold; border: 1px solid;">
                        <td class="t b" colspan="8" align="left" height="15">
                            Jumlah {{ $nama_desa }}
                        </td>
                ...
                <tr>
                    ...
                    <td class="style27 top right" colspan="13">
            ...
            <tr align="right" height="15px" class="style9">
                ...
                <td class="left top">{{ $Jenis_Agunan }}</td>
                <td class="left top right" align="left">{{ $Nilai_Agunan }}</td>
            </tr>
