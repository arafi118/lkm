<div class="modal-content">
    ...
    <div class="modal-body">
        <form action="/database/agent" method="post" id="FormRegisterAgent">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="position-relative mb-3">
                        <label for="kd_agent" class="form-label">Kode Agen</label>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="position-relative mb-3">
                        ...
                        <input autocomplete="off" type="text" name="nohp" id="nohp" value="+62"
    ...
    <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-dark btn-sm" id="SimpanAgent">Simpan Agen</button>
    </div>
</div>
<script>
