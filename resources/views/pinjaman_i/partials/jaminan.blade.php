    ...
    <div class="row">
        <div class="col-md-4">
            <div class="position-relative mb-3">
                ...
                <input autocomplete="off" type="text" name="data_jaminan[alamat]" id="alamat"
                    class="form-control">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="position-relative mb-3">
                ...
                <input autocomplete="off" type="text" name="data_jaminan[nopol]" id="nopol"
                    class="form-control">
        ...
        <div class="col-md-4">
            <div class="position-relative mb-3">
                ...
                <input autocomplete="off" type="text" name="data_jaminan[nilai_jual_kendaraan]"
                    id="nilai_jual_kendaraan" class="form-control">
...
@else
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="position-relative mb-3">
                <label for="luas" class="form-label">Luas (m²)</label>
                <input autocomplete="off" type="text" name="data_jaminan[luas]" id="luas"
                    class="form-control">
                <small class="text-danger" id="msg_luas"></small>
            </div>
        </div>
