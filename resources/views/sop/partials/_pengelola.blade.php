 <form action="/pengaturan/pengelola/{{ $kec->id }}" method="post" id="FormPengelola">
     ...
     <div class="row">
         <div class="col-md-6">
             <div class="position-relative mb-3">
                 <label class="form-label"for="sebutan_pengawas">Sebutan Pengawas </label>
         ...
         <div class="col-md-6">
             <div class="position-relative mb-3">
                 <label class="form-label"for="sebutan_verifikator">Sebutan Verifikator</label>
     ...
     <div class="row">
         <div class="col-md-6">
             <div class="position-relative mb-3">
                 <label class="form-label" for="kepala_lembaga">Sebutan Kepala Lembaga</label>
         ...
         <div class="col-md-6">
             <div class="position-relative mb-3"><label class="form-label" for="kabag_administrasi">Sebutan
                     Kabag Administrasi</label>
     ...
     <div class="row">
         <div class="col-md-6">
             <div class="position-relative mb-3">
                 <label class="form-label"for="kabag_keuangan">Sebutan Kabag
                     Keuangan</label>
         ...
         <div class="col-md-6">
             <div class="position-relative mb-3">
                 <label class="form-label" for="bkk_bkm">BKK/BKM</label>
