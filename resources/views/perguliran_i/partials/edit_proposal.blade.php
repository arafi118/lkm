    ...
    <div class="row">
        <div class="col-md-3">
            <div class="position-relative mb-3">
                ...
                <select class="js-example-basic-single form-control" name="id_agent" id="id_agent"
                    style="width: 100%;">
        ...
        <div class="col-md-3">
            <div class="position-relative mb-3">
                ...
                <input autocomplete="off" type="text" name="nama_barang" id="nama_barang"
                    value="{{ $perguliran_i->nama_barang }}" class="form-control">
        ...
        <div class="col-md-3">
            <div class="position-relative mb-3">
                ...
                <select class="js-example-basic-single form-control" name="jenis_jasa_proposal"
                    id="jenis_jasa_proposal">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="position-relative mb-3">
                ...
                <select class="js-example-basic-single form-control" name="sistem_angsuran_pokok_proposal"
                    id="sistem_angsuran_pokok_proposal">
        ...
        <div class="col-md-4">
            <div class="position-relative mb-3">
                ...
                <select class="js-example-basic-single form-control" name="sistem_angsuran_jasa_proposal"
                    id="sistem_angsuran_jasa_proposal">
                    @foreach ($sistem_angsuran as $sa)
            ...
            <div class="position-relative mb-3">
                ...
                <select class="js-example-basic-single form-control" name="jaminan" id="jaminan"
                    ...
                    @foreach ($editjaminan as $j)
                        <option
                            {{ is_array($jaminan) && isset($jaminan['jenis_jaminan']) && $jaminan['jenis_jaminan'] == $j['id'] ? 'selected' : '' }}
                            value="{{ $j['id'] }}">
                            {{ $j['nama'] }}
                        </option>
                    @endforeach
