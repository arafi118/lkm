                ...
                <div class="card-body">
                    ...
                    <div class="card-body">
                        ...
                        @php
                            ...
                            $user_boleh_akses = auth()->user()->jabatan == '1' && auth()->user()->level == '1' || auth()->user()->jabatan == '3' && auth()->user()->level == '1'&& ($kecamatan->id == '351' ||$kecamatan->id == '352' ||$kecamatan->id == '353' ||$kecamatan->id == '354' );
