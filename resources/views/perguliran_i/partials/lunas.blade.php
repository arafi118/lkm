...
@section('content')
    ...
    <div class="app-main__inner">
                ...
                <div class="col-lg-12">
                    <div class="main-card mb-3 card"><br>
                        <div class="page-title-heading">&nbsp;&nbsp;&nbsp;
                            <div>
                                <h5 class="mb-1"><b> Atas Nama {{ $perguliran_i->anggota->namadepan }} Loan ID.
                                        {{ $perguliran_i->id }}
                                        {{ $perguliran_i->jpp->nama_jpp }} {{ $kec->nama_lembaga_sort }}</b></h5>

                                <div class="page-title-subheading">
                                    <span
                                        class="badge mb-2 me-2 btn badge-light-reed">{{ $perguliran_i->anggota->nik }}</span>
                                    <span
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="main-card mb-3 card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Dengan mempertimbangkan Standar Operasional Prosedur (SOP) yang berlaku,
                            dengan ini Saya selaku {{ $kec->sebutan_level_1 }},{{ $kec->nama_lembaga_sort }}
                    ...
                    <div class="card-body">
                        <h5 class="card-title"> REKAPITULASI ANGSURAN </h5>
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-sm-8">
                                <div class="form-check">
                                    <input id="checkboxLunaskan" type="checkbox" value="checked"
        ...
        <div class="main-card mb-3 card">
            <div class="card-body">
                <a href="/perguliran_i?status=L" class="btn-shadow me-3 btn btn-primary" style="float: right;">
