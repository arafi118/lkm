...
<body onload="window.print()">
    @foreach ($pinkel->pinjaman_anggota as $pinj)
        ...
        <main style="position: relative; font-size: 12pt;">
            <table border="0" width="100%" cellspacing="0" cellpadding="0" style="font-size: 11pt; opacity: 0;">
                <tr>
                    <td rowspan="7" align="center" width="400">
                        ...
                        <div style="font-size: 14pt;">{{ $pinkel->anggota->id }}</div>
                    </td>
            ...
            <table border="0" width="100%" cellspacing="0" cellpadding="0"
                style="font-size: 11pt; opacity: 0;">
                <tr>
