...
@section('content')
    ...
    <table border="0" width="100%" align="center"cellspacing="0" cellpadding="0" style="font-size: 14pt;">
        <tr>
    ...
    <table border="1" width="100%" align="center"cellspacing="0" cellpadding="0" style="font-size: 14pt;">
        <tr>
        ...
        @foreach ($pinkel->pinjaman_anggota as $pa)
            ...
            <tr>
                ...
                <td>
                    <div class="fw-bold" style="font-size: 14pt;">{{ $pa->anggota->namadepan }}</div>
                </td>
