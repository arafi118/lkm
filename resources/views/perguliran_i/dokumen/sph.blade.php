...
@section('content')
    ...
    <div class="centered-text">
        Pada hari ini <b>{{ Tanggal::namaHari($pinkel->tgl_cair) }}</b> tanggal
        <b>{{ $keuangan->terbilang(Tanggal::hari($pinkel->tgl_cair)) }}</b> bulan
        <b>{{ Tanggal::namaBulan($pinkel->tgl_cair) }}</b>
    ...
    <div style="text-align: center;">
        <div class="centered-text">
            ...
            masing-masing surat untuk <b>Pihak Pertama</b> dan <b>Pihak Kedua</b>. Surat Perjanjian dibuat dan
            ditandatangani oleh kedua
            belah pihak secara sadar dan tanpa tekanan dari pihak manapun di tempat dan waktu penandatanganan Surat
            Perjanjian ini.
        </div>
    </div>
