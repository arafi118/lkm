...
@section('content')
    ...
    <div style="text-align: center;">
        ...
        <h3 class="fa fa-align-center" aria-hidden="true" style="font-size: 11pt; margin-top: 0;">Ayat 1</h3>
        <div class="centered-text">
    ...
    <div style="text-align: center;">
        <h3 class="fa fa-align-center" aria-hidden="true" style="font-size: 11pt;"> Ayat 2 </i> </h3>
        <div class="centered-text">
    ...
    <div style="text-align: center;">
        <h3 class="fa fa-align-center" aria-hidden="true" style="font-size: 11pt;"> Ayat 3 </i> </h3>
        <div class="centered-text">
    ...
    <div style="text-align: center;">
        <h3 class="fa fa-align-center" aria-hidden="true" style="font-size: 11pt;"> Ayat 1 </i> </h3>
        <div class="centered-text">
    ...
    <div style="text-align: center;">
        <h3 class="fa fa-align-center" aria-hidden="true" style="font-size: 11pt;"> Ayat 4 </i> </h3>
    ...
    <div style="text-align: center;">
        <h3 class="fa fa-align-center" aria-hidden="true" style="font-size: 11pt;"> Ayat 5 </i> </h3>
    ...
    <div style="text-align: center;">
        <h3 class="fa fa-align-center" aria-hidden="true" style="font-size: 11pt;"> Ayat 6 </i> </h3>
        <div class="centered-text">
    ...
    <div style="text-align: center;">
        ...
        <h3 class="fa fa-align-center" aria-hidden="true" style="font-size: 11pt; margin-top: 0;"> Ayat
            1</h3>
        <div class="centered-text">
